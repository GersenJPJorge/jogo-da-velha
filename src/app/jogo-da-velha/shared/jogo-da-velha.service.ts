...
export class JogoDaVelhaService {
  ...
  // readonly porque são atributos imutáveis, por convenção estçao com letras maiúsculas

  private tabuleiro: any;                       // será um array multidimensional 3x3
  private numMovimentos: number;                // maior ou igual a 9 terminou em empate
  private vitoria: any;                         // posicoes das peças vitoriosas
   ...
   * @return boolean
   */ 
// como showinicio é uma varável privada, só podemos acessá-la através do método get (que é do typescript) 
get showInicio(): boolean {
    return this._showInicio;
    // retorna a flag se deve ser exibida ou não.
  }
...
// quando clicado em iniciar jogo 
iniciarJogo(): void {
